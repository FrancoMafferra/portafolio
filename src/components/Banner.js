      ...
      <div className="container mx-auto flex items-center justify-center">
        <div className="w-2/3 lg:w-1/3">
          ...
          <p className="text-lg mb-6">
            In addition to my technical background, I consider myself a
            committed and dedicated professional. I love working as a team and
            collaborating closely with my clients to understand their needs and
            offer tailor-made solutions. My main goal is to create quality
            digital experiences that are visually appealing and easy to use.
          </p>
